...
async function sendWithResend(payload) {
  ...
  const toEmail = process.env.CONTACT_EMAIL || process.env.CONTACT_MAIL || 'giovanni.pitton2@gmail.com';
...
Inviato dal modulo contatti del sito web.
    ...
    else if (EMAIL_PROVIDER === 'brevo') result = await sendBrevo({ subject: payload.subject, text: payload.text, html: payload.html, to: process.env.CONTACT_EMAIL || process.env.CONTACT_MAIL || 'giovanni.pitton2@gmail.com', replyTo: payload.replyTo });
