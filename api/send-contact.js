...
Inviato dal modulo contatti del sito web.
    ...
    else if (EMAIL_PROVIDER === 'brevo') result = await sendBrevo({ subject: payload.subject, text: payload.text, html: payload.html, to: 'giovanni.pitton2@gmail.com', replyTo: payload.replyTo });
